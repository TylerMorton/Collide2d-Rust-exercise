...
pub fn colission_update2(l1: [f32;2], m1: f32, x1: [f32; 2],  l2: [f32; 2], m2: f32, x2: [f32;2]) -> [[f32; 2]; 2] {
  let v1 = arr1(&l1);
  let v2 = arr1(&l2);
...
use super::*;
  ...
  fn collision() {
    ...
    assert_eq!(colission_update2(p1.0, p1.1, p1.2, p2.0, p2.1, p2.2), [[3.8601198, -2.6006947], [-1.8601198, 3.9006948]]);
  }
